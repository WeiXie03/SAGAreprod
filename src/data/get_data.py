...
'''
Searches ENCODE for ChIP-seq experiments with the given cell type.
If check_availability is True, check if replicates available. If False, download the data.
'''
...
if __name__ == "__main__":
    get_data_from_csv(csvfile ="../../data/data_summary.csv", downloaddir="../../data/")
